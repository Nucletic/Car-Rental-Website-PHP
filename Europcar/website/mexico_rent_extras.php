...
<body>
    ...
    <div class="doro">
        <div class="crwdcbg">
            <h1 id="crwdcbg_h1">Extra Services</h1>
            <img src="images/ec_prod_extras.jpg">
        </div>
        <div class="wdin">
            <div class="eurocar_title">
                ...
                <ul>
                    ...
                    <li><a href="mexico_rent_extras.php" class="eurocar_active_btn">Extras</a></li>
                </ul>
                </ul>
            </div>

            <div class="extras">
                <div class="extras_main">
                    <div class="extras_main_title">
                        <img src="images/ec_ex_entr.png">
                        <h2>Delivery and Drop-Off Services</h2>
                    </div>
                    <p>Europcar offers home - or business-delivery and drop-off services
                        for rentals of cars or vans in urban areas.</p>
                </div>
                <div class="extras_main">
                    <div class="extras_main_title">
                        <img src="images/ec_ex_seat.png">
                        <h2>Baby Car Seat</h2>
                    </div>
                    <p>Comfort and safety for the youngest passengers riding in our vehicles,
                        for only 10.00 USD/day (+ VAT)</p>
                    <p>Age must be indicated at time of booking. CSI child seat infant from birth
                        to 12 months - CSB baby seat from 12 months to 3 years - CST toddler seat
                        from 4 years to 7 years.</p>
                </div>
                <div class="extras_main">
                    <div class="extras_main_title">
                        <img src="images/ec_ex_gas.png">
                        <h2>Full Tank</h2>
                    </div>
                    <p>Enjoy yourself and forget about refueling before returning the vehicle.</p>
                </div>
                <div class="extras_main">
                    <div class="extras_main_title">
                        <img src="images/ec_ex_addcon.png">
                        <h2>Additional Driver</h2>
                    </div>
                    <p>Two are better than one! Request the option of an additional driver
                        (Driver maximum age is 69 years old) from your office or when making
                        your reservation online for only 10.00 USD/day + VAT</p>
                </div>
            </div>
        </div>
    </div>
