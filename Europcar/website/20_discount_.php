    ...
    <div class="doro">
        <div class="del_ret_form">
            <div class="page_main_title">
                <h2>BOOK IN ADVANCE AND SAVE UP TO 20%</h2>
        ...
        <div class="pnwc">
            <div class="pnagrd">
                <div class="pnagrd_title">
                    <h2>Book in Advance and Save up to 20%</h2>
                    <p>Book 28 days in advance and get up to 20% off paying online! (Time and Mileage)</p>
                </div>
                <div class="terms_and_con">
                    <ul>
                        ...
                        <li>
                            ...
                            <p>Valid for reservations of minimum 2 rental days made with 28 days in advance</p>
                        </li>
                        <li>
                            <i class="fa fa-check"></i>
                            <p>This offer is not valid on renting plans</p>
                        </li>
                        <li>
                            <i class="fa fa-check"></i>
                            <p>The offer is not cumulative.</p>
                        </li>
                        <li>
                            <i class="fa fa-check"></i>
                            <p>Validity: From Monday 25 de January 2021 to Friday 31 de December 2021</p>
                        </li>
                    </ul>
                </div>
            </div>
