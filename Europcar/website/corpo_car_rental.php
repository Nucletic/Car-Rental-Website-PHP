...
<body>
    ...
    <div class="doro">
        <div class="crwdcbg">
            <h1 id="crwdcbg_h1">Our Corporate Agreements</h1>
            <img src="images/ec_prod_corpo.jpg">
        </div>
        <div class="wdin">
            <div class="eurocar_title">
                <h2>Our Corporate Agreements</h2>
                <ul>
            ...
            <div class="rycw_main">
                <h2>Corporate Agreement</h2>
                <p>
                    This agreement grants you the full benefit of having a dynamic fixed rate that
                    is valid throughout the country in any of our categories of cars.
                </p>
                <div class="pcwh">
                    <h4>This rate includes the following benefits:</h4>
                    <ul>
                        <li>Free mileage.</li>
                        <li>Full coverage.</li>
                        <li>Centralized invoicing.</li>
                        <li>Substitute cars.</li>
                        <li>Easy guarantees.</li>
                        <li style="width: auto!important;">Preferential drop-off prices.</li>
                        <li style="width: auto!important;">Others, such as: zero deductible coverage,
                            home delivery service, extras.</li>
                    </ul>
                </div>
                <p>The purpose of this plan is to provide you with a specific rate in accordance with
                    your needs and rental volume.</p>
                <p>Credit may be available, according to customer and line of business.</p>
                <p>For further information, <a href="mailto:sales@yatiglobalsolutions.com">click here.</a></p>
            </div>
        </div>
    </div>
    <footer>
