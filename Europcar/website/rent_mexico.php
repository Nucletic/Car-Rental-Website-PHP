...
<body>
    ...
    <div class="doro">
        <div class="del_ret_form mexico">
            <div class="page_main_title">
                <h2>Car Rental Mexico City</h2>
            </div>
        ...
        <div class="botm_para">
            <div class="botm_para2">
                <p>
                    Europcar has for you the best options for renting a car in Mexico City. Our offices are located at
                    strategic points throughout the city. You can find us at the International Airport of Mexico City.
                    We also have offices on the main roads of the Capital in Reforma or Insurgentes Sur.
                </p>
                <p>
                    If your required a vehicle for a big crow, we have vans that can accommodate up to 15 people.
                    In addition we have a variety of vehicles to choose; Economic cars or Eco friendly vehicles.
                </p>
                <p>
                    One of the city's most treasured open spaces is Chapultepec Park, which at 1,600 acres is the
                    largest wooded area in the all city. Chapultepec, which in the famous Nahuatl language means
                    "Hill of the Grasshopper", also is important historically. Aztec emperors used this park for
                    hunting and recreation. Tenochtitlan also got its drinking water from this park. During colonial
                    times, the Spanish built many buildings here at Chapultepec, including a mansion that became
                    Mexico's military academy. The United States troops attacked and captured the school, known as
                    Chapultepec Castle, during the final battle of the Mexican-American War, on September 13, 1847.
                    Today, Chapultepec is home to some of the city's finest and beautiful museums.
                </p>
                <h3>
                    We are the best option renting a car in Mexico City
                </h3>
                <p>
                    Move around the big city comfortably and take control of your time in your next trip to Mexico City,
                    take advantage of the offers when you rent a car in Mexico City for work or vacations.
                </p>
                <p>
                    Rent a car with our car rental and visit many other large parks in the city, including the Alameda
                    Central near the famous Zocalo. Created in 1592, the Alameda was an exclusive area reserved for all
                    the well-to-do. Today, the Alameda is known for strolling couples who hold hands during very romantic
                    interludes. Viveros, a large park in Coyoacan, is very popular with runners and walkers who come to
                    do laps among the large trees. The Desert of the Lions ("El Desierto de los Leones"), southwest
                    of the city, is known for its large beautiful open spaces, mountains, forests, and springs.
                </p>
                <p>
                    Renting with us can allow also visit the Papalote Children's Museum, and the museums of natural history
                    and technology. While driving thru Mexico City you have to visit Coyoacan, it has the Frida Kahlo Museum
                    while Xochimilco is home to the Dolores Olmedo Museum, which has important works by Kahlo and Diego Rivera.
                    Many of the museums are free on Sundays. The city is also home to the famous National Library.
                </p>
                <p>
                    Visit us in our offices or call to the call center from México 01 (800) 201-2084, from EU & Canada
                    (1-877) 526-8679 and from others +52 (998) 884-3003.
                </p>
                <h3>
                    Europcar Offcices In México Centro
                </h3>
                <a href="">See on Map</a>
            </div>
            <div class="city_airport">
                <div class="city_airport_main">
                    <h3>Mexico - Renovation</h3>
                    <p><strong>Address:</strong> Av. Paseo de la Reforma 208, Local A, Col.
                        Juárez, Cuauhtémoc Delegation, Mexico City, CDMX.</p>
                    <p><strong>Telephone:</strong> <a href=""> +52 (555) 525 1096</a></p>
                    <a href="javascript:void(0)" class="office_select_btn">SELECT THIS OFFICE <i class="fa fa-chevron-right"></i></a>
                </div>
                <div class="city_airport_main">
                    <h3>Mexico - Airport - Check In</h3>
                    <p><strong>Address:</strong> Av. Capitán Carlos León S/N, Peñón de los Baños,
                        Venustiano Carranza, CP 15620, Mexico City, CDMX.</p>
                    <p><strong>Telephone:</strong> <a href=""> +52 (551) 560 1773</a></p>
                    <a href="javascript:void(0)" class="office_select_btn">SELECT THIS OFFICE <i class="fa fa-chevron-right"></i></a>
                </div>
            </div>
            <div class="ooihz">
                <div class="right_ooihz">
                    ...
                    <div class="right_ooihz_content">
                        <ul class="acoh">
                            ...
                            <li>
                                <p>Av. Paseo de la Reforma 208, Local A, Col. Juárez, Cuauhtémoc Delegation, Mexico City, CDMX.</p>
                            </li>
                            <li>
                                <h3>Contact:</h3>
                            </li>
                            <li>
                                <p><a href="">+52 (555) 525 1096</a></p>
                            </li>
                            <li>
                                <h3>Opening Hours:</h3>
                            </li>
