...
<body>
    ...
    <div class="doro">
        <div class="contact_page_d">
            <div class="contact_title">
                <h1>Contact Us</h1>
            </div>
            <div class="booking_center_contact">
                <h3>Booking Center</h3>
                <ul>
                    <li>
                        <p>Toll-free long distance</p>
                    </li>
                    <li><a href="">(800) 201 2084</a></li>
                    <li><a href="">(800) 436 0310</a></li>
                    <li><a href="">(800) 201 1111</a></li>
                    <li><a href="">(800) 201 2222</a></li>
                    <li><a href="">(800) 201 3333</a></li>
                    <li>
                        <p>USA and Canada:</p>
                    </li>
                    <li>
                        <a href="">+1 877 704 9690</a>
                    </li>
                    <li>
                        <p>From WhatsApp:</p>
                    </li>
                    <li>
                        <a href="">+52 (998) 246 5459</a>
                    </li>
                </ul>
            </div>
            <div class="schedule_contact">
                <div class="contact_sc_em_lo_po_title">
                    <h3>Schedule</h3>
                </div>
                <p>Monday through Sunday</p>
                <p>24 hours a day (GMT -06:00) 365 days a year</p>
            </div>
            <div class="second_contact_title">
                <h3>Contact us</h3>
            </div>
            <div class="schedule_contact">
                <div class="contact_sc_em_lo_po_title">
                ...
                <a href="">mx_customerservice@europcar.com.mx</a>
            </div>
            <div class="schedule_contact">
                <div class="contact_sc_em_lo_po_title">
                    <h3>Loyalty program:</h3>
                </div>
                <span>Sign up by sending an email with your information to</span>
                <a href="">promociones@europcar.com.mx</a><br>
                <span>Response time 24 hours on business days.</span>
            </div>
            <div class="schedule_contact">
                <div class="contact_sc_em_lo_po_title">
                    <h3>Postal Code</h3>
                ...
                <p>Europcar México</p>
                <p>Carretera Cancún-Chetumal Km. 22,</p>
                <p>Lotes 1, 2 y 3, Aeropuerto Internacional Cancún, Quintana Roo 77500, México</p>
            </div>
        </div>
    </div>
    <footer>
