...
<body>
    ...
    <div class="doro">
        <div class="crwdcbg">
            <h1 id="crwdcbg_h1">Substitutes Car Service</h1>
            <img src="images/ec_prod_sust.jpg">
        </div>
        <div class="wdin">
            <div class="eurocar_title">
                <h2>Substitutes Car Service</h2>
                <ul>
                    <ul>
                        ...
                        <li><a href="substi_car_mexico.php" class="eurocar_active_btn">Subsitute</a></li>
                        <li><a href="mexico_rent_extras.php">Extras</a></li>
                    </ul>
                </ul>
            </div>
            <div class="rycw_main">
                <h2>Substitute Car</h2>
                <p>
                    Europcar provides companies dedicated to services to end users with the
                    opportunity to improve their consumers' experience.
                </p>
                <p>
                    This product consists of providing a car for the user to make temporary
                    use of for a period of 1 to 15 days at a preferential rate.
                </p>
                <p>
                    The service is geared to automobile agencies, car servicing companies,
                    auto repair shops and insurance companies.
                </p>
