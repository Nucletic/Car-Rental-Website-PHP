        ...
        <div class="pnwc">
            <div class="pnagrd">
                <div class="pnagrd_title">
                    <h2>3X2 WEEKEND!</h2>
                    <p>1 day free! Rent a car with Europcar from Friday to Sunday and enjoy
                        1 rental day for free! (Time and Mileage). Valid from February 14 - April 2022.</p>
                </div>
                <div class="terms_and_con">
                    <ul>
                        ...
                        <li>
                            ...
                            <p>Valid for reservations with minimum 3 rental days</p>
                        </li>
                        <li>
                            <i class="fa fa-check"></i>
                        ...
                        <li>
                            <i class="fa fa-check"></i>
                            <p>Validity: From Monday 14 de February 2022 to Tuesday 22 de March 2022</p>
                        </li>
                    </ul>
                </div>
            </div>
