...
<body>
    ...
    <div class="doro">
        <div class="crwdcbg">
            <h1 id="crwdcbg_h1">Europcar Car Hire</h1>
            <img src="images/ec_prod_renta-autos.jpg">
        </div>
        <div class="wdin">
            <div class="eurocar_title">
                <h2>Europcar Car Hire</h2>
                <ul>
                    <li><a href="car_rental_mexico.php">Car Rental</a></li>
                    <li><a href="corpo_car_rental.php" class="eurocar_active_btn">Corporate</a></li>
                    <li><a href="auto_rent_mexico.php">Renting</a></li>
                    <li><a href="substi_car_mexico.php">Subsitute</a></li>
                    <li><a href="mexico_rent_extras.php">Extras</a></li>
                </ul>
            </div>
            <div class="rycw_main">
                <h2>Rent your car with Europcar</h2>
                <p>
                    At Europcar you will find the latest models of cars of the best brands: General Motors,
                    Volkswagen, Chrysler, Ford, Renault, Toyota, Peugeot, Nissan, BMW, and others.
                </p>
                <p>
                    Our fleet ranges from economy, compact, mid size to luxury cars,
                    including SUVs, 4x4 ATVs and even utility vans.
                </p>

                <div class="pcwh">
                    <h4>The principal categories we handle are:</h4>
                    <ul>
                        <li>Economy (Atos).</li>
                        <li>Compact (Chevy, Clio or similar).</li>
                        <li>Mid size (Aveo or similar).</li>
                        <li>Standard (Sentra, Megane or Similar).</li>
                        <li>SUV (Nitro, Patriot, Koleos).</li>
                        <li>Premium (Mercedes Benz E280, Audi A6 and Chrysler Grand Voyager).</li>
                        <li>Vans (Journey, Suburban, Durango, Van Express).</li>
                        <li>Utility vans (Traffic , Kangoo, F-350)</li>
                    </ul>
                </div>
                <p>The choice of fleet comes basically in response to criteria intended to satisfy the demands
                    of our customers, but it also takes into account novelty, quality and safety.</p>
                <p><a href="">Click here</a> to visit our website, where we will show you our fleet and provide
                    you with all the information you need concerning our vehicles.</p>
                <p>Europcar is also interested in facilitating your travels, which is why it is offering you the
                    possibility of access to additional equipment such as: Bluetooth or Baby Car Seat, Home Delivery,
                    Chauffer Service.</p>
                <p>For further information, <a href="">Click here.</a></p>
