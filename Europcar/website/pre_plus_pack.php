...
<body>
    ...
    <div class="doro">
        <div class="crwdcbg">
            <img src="images/banner-landing-premium-plus.jpg">
        </div>
        <div class="wdin">
            <div class="ppp_title">
                <h2>PREMIUM PLUS PACKAGE - TOTAL COVERAGE</h2>
                <p>At Europcar Mexico we know that your time is essential and that is why we have designed
                    a product adapted to today's digital needs, helping to improve your car rental experience.</p>
            </div>
            <div class="ppp_feature">
                <ul>
                    <li class="ppp_feature_1">
                        <img src="images/ico-tanque-lleno.svg" width="30px" height="38px">
                        <div class="ppp_feature_ttl_p" style="margin-left: 10px;">
                            <h3>Full tank</h3>
                            <p>You will receive the car with a full tank, so that you can start your
                                adventure without mishap. On the return do not worry about the fuel level.</p>
                        </div>
                    </li>
                    <li class="ppp_feature_2">
                        <img src="images/ico-contrato-digital.svg" width="30px" height="37px">
                        <div class="ppp_feature_ttl_p" style="margin-left: 10px;">
                            <h3>High protection</h3>
                            <p>You can travel with peace of mind since you have full coverage and 0% deductible.</p>
                        </div>
                    </li>
                    <li class="ppp_feature_3">
                        <img src="images/ico-check-in-online.svg" width="40px" height="36px">
                        <div class="ppp_feature_ttl_p" style="margin-left: 0px;">
                            <h3>Digital Contract</h3>
                            <p>Now your contract is digital and it reaches your email.</p>
                        </div>
                    </li>
                    <li class="ppp_feature_4">
                        <img src="images/ico-serviceExpress.svg" width="40px" height="47px">
                        <div class="ppp_feature_ttl_p" style="margin-left: 0px;">
                            <h3>Express service</h3>
                            <p>Upon arrival you will not have to wait or wait in line, provide your reservation
                                number to Europcar staff and they will immediately assist you, your car will be
                                ready for you to start your trip.</p>
                        </div>
                    </li>
                    <div class="ppp_feature_ttl_note">
                        <p>* Direct to the car, only available in Cancun, for the rest of the republic, go to the
                            office by the keys of your car showing your reservation, without queuing and no waiting time.</p>
                    </div>
                </ul>
            </div>
            <div class="ppp_hdit">
                <div class="ppp_hdit_title">
                    <h2>How does it work?</h2>
                    <p>It's simple, just follow these steps:</p>
                </div>
                <div class="ppp_hdit_main">
                    <div class="ppp_hdit_real_main_1">
                        <div class="ppp_hdit_real_main_1_img">
                            <img src="images/ico-foto-cel.svg">
                        </div>
                        <h2>Make a reservation from the Europcar website</h2>
                    </div>
                    <div class="ppp_hdit_real_main_2">
                        <div class="ppp_hdit_real_main_2_img">
                            <h2>PREMIUM<br><span>+PLUS</span></h2>
                        </div>
                        <h2>Add the PREMIUM PLUS package</h2>
                    </div>
                    <div class="ppp_hdit_real_main_3">
                        <div class="ppp_hdit_real_main_3_img">
                            <h2>3D<br><span>SECURE</span></h2>
                        </div>
                        <h2>Your card must count are 3D Secure</h2>
                    </div>
                </div>
                <div class="ppp_feature_ttl_note">
                    <p>Now you can live the fastest rental experience and with the best technological
                        monitoring at every step of your reservation.</p>
                </div>
            </div>
            <div class="ppp_coverage">
                <div class="ppp_coverage_left">
                    <div class="ppp_coverage_left_title">
                        <h2>PREMIUM PLUS PACKAGE COVERAGE</h2>
                        <p>It is one of our packages with greater privileges, since you have full
                            coverage, you will not have to worry about anything, just enjoy your trip.</p>
                    </div>
                    <div class="ppp_coverage_left_img">
                        <img src="images/GettyImages.png">
                    </div>
                </div>
                <div class="ppp_coverage_right">
                    <ul>
                        <li>
                            <img src="images/c1.png">
                            <p>Collision and Damage (CDW)</p>
                            <i class="fa fa-check"></i>
                        </li>
                        <li>
                            <img src="images/c2.png">
                            <p> Civil Liability (PLI)</p>
                            <i class="fa fa-check"></i>
                        </li>
                        <li>
                            <img src="images/c3.png">
                            <p>Theft Protection (THW)</p>
                            <i class="fa fa-check"></i>
                        </li>
                        <li>
                            <img src="images/c4.png">
                            <p>Roadside assistance (RSA)</p>
                            <i class="fa fa-check"></i>
                        </li>
                        <li>
                            <img src="images/c5.png">
                            <p>Occupying Medical Expenses (PAI)</p>
                            <i class="fa fa-check"></i>
                        </li>
                        <li>
                            <img src="images/c6.png">
                            <p>Crystals and Tires (WWI)</p>
                            <i class="fa fa-check"></i>
                        </li>
                        <li>
                            <img src="images/c7.png">
                            <p>0% Deductible Coverage (SPLDW)</p>
                            <i class="fa fa-check"></i>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <p>Express service, no waiting time</p>
                            <i class="fa fa-check"></i>
                        </li>
                    </ul>
                </div>
            ...
            <div class="secure_3d">
                <h2>3D SECURE</h2>
                <p>3D Secure is an additional security measure for credit card transactions.
                    When the cardholder makes a 3D Secure payment, he not only enters the card
                    number but also a code or password.</p>
                <p>This is a security measure is to avoid fraudulent transactions and have greater
                    protection while maintaining the privacy of transactions.</p>
                <div class="secure_3d_img">
                    <img src="images/images.png">
                </div>
                <p>To activate this payment system, you must request it from your banking institution,
                    it is easy to activate and use.</p>
            </div>
            <div class="woyt">
                <div class="woyt_main">
                    <h2>We optimize your time to the fullest</h2>
                    <p>If you already have a reservation, make your <strong>Check In Online,</strong>
                        just follow these simple steps to improve your experience in the delivery of your car.</p>
                    <a href="mainpage.php">KNOW MORE</a>
                </div>
            </div>
        </div>
    </div>
