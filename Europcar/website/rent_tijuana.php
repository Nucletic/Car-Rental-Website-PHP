...
<body>
    ...
    <div class="doro">
        <div class="del_ret_form tijuana">
            <div class="page_main_title">
                <h2>Car Rental Tijuana</h2>
            </div>
        ...
        <div class="botm_para">
            <div class="botm_para2">
                <p>
                    This border city is like unique! Here you can drive thuough its streets and immerse yourself
                    in its multifaceted and vibrant culture. It has its own charm and is a melting pot of the
                    regional diversities of Mexico and other beautiful cultures beyond its borders.
                </p>
                <p>
                    Take a tour during the day to La Cerveceria Tijuana and go to the bars and restaurants
                    that make this iconic city famous. Drive to the museums or simply chill at the beach
                    watching the sunset.
                </p>
                <p>
                    The eclectric style of this city will hypnotize you with its walls turned into street art
                    exhibitions, its old commercial passages taken <strong>by independent plastic artists</strong>
                    , its historic buildings and its monumental arch, architectural icon within its avant-garde style.
                </p>
                <h3>
                    We are the best option renting a car in Tijuana
                </h3>
                <p>
                    Tijuana's nightlife scene is one of the city's strongest attractions. The area surrounding "La Sexta",
                    the intersection at Calle Sexta and Av. Revolución, is now a major hub of new bars and dance clubs.
                    Zona Rio, Tijuana's new Downtown, is home to some of the city's finest restaurants and bars.
                    Another capstone of Tijuana's entertainment offerings is its exiting adult nightlife industry,
                    which includes the city's red light district as well as less conspicuous adult entertainment venues.
                </p>
                <p>
                    To visit all the attractions of Tijuana, <strong>rent a car from Europcar Mexico and take advantage
                        of the great deals we have when you book online.</strong>
                </p>
                <h3>
                    Europcar Offcices In Tijuana
                </h3>
                <a href="">See on Map</a>
            </div>
            <div class="city_airport">
                <div class="city_airport_main">
                    <h3>Tijuana - Aeropuerto Check In</h3>
                    <p><strong>Address:</strong> Blvd. al Aeropuerto S/N Col. Nueva Tijuana, Mesa de Otay,
                        seccion de arrendadoras. C.P 22435 Tijuana, B.C.N</p>
                    <p><strong>Telephone:</strong> <a href=""> +52 (664) 683 8567</a></p>
                    <a href="javascript:void(0)" class="office_select_btn">SELECT THIS OFFICE <i class="fa fa-chevron-right"></i></a>
                </div>
                <div class="city_airport_main">
                    <h3>Tijuana - Puente Peatonal a Estados Unidos</h3>
                    <p><strong>Address:</strong> Blvd. al Aeropuerto S/N Col. Nueva Tijuana, Mesa de Otay, seccion de</p>
                    <p><strong>Telephone:</strong> <a href=""> +52 (664) 683 8567</a></p>
                    <a href="javascript:void(0)" class="office_select_btn">SELECT THIS OFFICE <i class="fa fa-chevron-right"></i></a>
                </div>
            </div>
            <div class="ooihz">
                <div class="right_ooihz">
                    <div class="right_ooihz_title">
                        <h2>Tijuana - Aeropuerto Check In</h2>
                    </div>
                    <div class="right_ooihz_content">
                        <ul class="acoh">
                            ...
                            <li>
                                <p>Blvd. al Aeropuerto S/N Col. Nueva Tijuana, Mesa de Otay,
                                    seccion de arrendadoras. C.P 22435 Tijuana, B.C.N</p>
                            </li>
                            <li>
                                <h3>Contact:</h3>
