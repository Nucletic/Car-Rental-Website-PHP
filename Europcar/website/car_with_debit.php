...
<body>
    ...
    <div class="doro">
        <div class="crwdcbg">
            <img src="images/renta-de-autos-con-tarjeta-de-debito.png">
            <h1 id="crwdcbg_h1">Car rental with debit card</h1>
        </div>
        <div class="wdin_main">
            <div class="wdin">
                <p>Now you can use your debit card instead of a credit card to rent a car at any of the Europcar Mexico offices.
                    Book rental cars in the main destinations of Mexico without worrying about having a credit card,
                    because now you can rent a car with debit leaving the amount indicated when booking from our
                    official website (Equivalent to 10% of the total value of the car ).</p>
                <h2>What do I need to rent a car with a debit card?</h2>
                <li>The cardholder must be the same person as the main driver.</li>
                <li>The debit card must have the amount indicated for the security deposit.</li>
                <p>Now there will be no more excuses to continue postponing that trip where you could well
                    be touring the beautiful corners of Mexico, because with Europcar, renting a car will
                    be much easier, without a credit card and with affordable prices. Go to our search
                    engine and book right now to benefit from the best possible prices, remember that
                    the more you book in advance, the more chances you have to find cheap prices, as
                    rates tend to rise as the dates approach</p>
            </div>
            <div class="wcem">
            ...
            <div class="t_and_c">
                ...
                <p>Does not apply CDMX, Puerto Vallarta and Villahermosa offices.</p>
                <p>The debit card must have the amount indicated for the car warranty.</p>
                <p>When using your debit card the amount will be charged as one more sale,
                    so at the end of the rental of the car the refund of the deposit will be
                    made with a charge of 5% on the amount reimbursed, as a bank commission
                    for this transaction.</p>
                <p>Reservations of 4 days or more in the categories of economic, compact,
                    and intermediate cars will not be charged a fee for reimbursement.</p>
                <p>The refund will be made from 24 to 72 hours, but it will depend on the
                    bank the time in which this amount is reflected again in your account.</p>
            </div>
        </div>
    </div>
    <footer>
