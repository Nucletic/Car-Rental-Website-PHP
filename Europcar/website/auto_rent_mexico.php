...
<body>
    ...
    <div class="doro">
        <div class="crwdcbg">
            <h1 id="crwdcbg_h1">AutoRenting Service</h1>
            <img src="images/ec_prod_renting.jpg">
        </div>
        <div class="wdin">
            <div class="eurocar_title">
                <h2>AutoRenting Service</h2>
                <ul>
                    <li><a href="car_rental_mexico.php">Car Rental</a></li>
                    <li><a href="corpo_car_rental.php">Corporate</a></li>
                    <li><a href="auto_rent_mexico.php" class="eurocar_active_btn">Renting</a></li>
            ...
            <div class="rycw_main">
                <h2>AutoRenting</h2>
                <p>
                    This plan offers access to a vehicle for you to use for medium to long periods of time, easily,
                    flexibly and profitably, where the vehicle may belong to either Europcar or the company.
                </p>
                <div class="pcwh">
                    <h4>PRINCIPAL BENEFITS RENTING EUROPCAR:</h4>
                    <ul>
                        <li style="width: 100%!important;">New units.</li>
                        <li style="width: 100%!important;">Full coverage including deductible.</li>
                        <li style="width: 100%!important;">License plate, emissions control verification and
                            tenencia (yearly local and federal registration fees) expenses.</li>
                        <li style="width: 100%!important;">Preventive maintenance and repairs.</li>
                        <li style="width: 100%!important;">Road assistance 24 hours a day,
                            365 days of the year, throughout all of Mexico.</li>
                        <li style="width: 100%!important;">Substitute vehicle at no extra cost.</li>
                        <li style="width: 100%!important;">Competitive fixed rate.</li>
                    </ul>
                </div>
                <p>*Aside from having the option to purchase or not, aside from important fiscal benefits.</p>
                <p>*The minimum term for this service is adapted to each company's needs.</p>
