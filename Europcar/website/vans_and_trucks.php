...
<body>
    ...
    <div class="doro">
        <div class="crwdcbg">
            <img src="images/camionetas.png">
            <h1 id="crwdcbg_h1">Rent of Trucks and Vans</h1>
        </div>
        <div class="wdin_main">
            <div class="wdin">
                <p>
                ...
                <p>
                    With the <strong>rental of trucks and vans </strong>of Europcar México, enjoy your trip without complications.
                </p>
                <p>
                    Here we explain how!
                </p>
                <p>
                    We have <strong>rental of family trucks and rental of passenger trucks </strong>for your trip to be
                    perfect and without complications. Our <strong>rental trucks</strong> are perfectly adapted to your
                    needs as we have several models of <strong>rental trucks and vans.</strong> Think no more! We have
                    offices in the main tourist destinations, the main cities and airports of the country. If you are
                    traveling and need <strong>vans to rent </strong>for your family holidays or for a trip with a
                    large group of people, you already know very well where to go.
                </p>
                <p>
                ...
                <p>
                    The <strong>rent of van</strong> and <strong>rent of minivan </strong>will help you on your trip
                    allowing you to move to the maximum where you like and need, without setbacks or complications.
                    Forget about taxis, public transportation schedules or depending on someone else.
                </p>
                <p>
                    Make your family trip perfect with the help of Europcar México and the <strong>rental of family
                        vans </strong>and <strong>rental of passenger vans </strong>that we have for you!
                </p>
                <p>
                    Remember, with Europcar Mexico there is always an office near you!
                </p>
            </div>
            <div class="cars_det">
