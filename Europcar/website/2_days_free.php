    ...
    <div class="doro">
        <div class="del_ret_form">
            <div class="page_main_title">
                <h2>
                    7X5 !PAY 5 NIGHTS AND GET 7 RENTAL DAYS!
                </h2>
                <span>2 days free!</span>
            </div>
        ...
        <div class="pnwc">
            <div class="pnagrd">
                <div class="pnagrd_title">
                    <h2>7x5 !Pay 5 nights and get 7 Rental Days!</h2>
                    <p>2 days free! Rent a Car with Europcar car and enjoy 2 rental days free of charge (Time and Mileage).
                        Valid from February 14 - April 22. 2022</p>
                </div>
                <div class="terms_and_con">
                    <ul>
                        <p class="terms_con_title">Terms and Conditions</p>
                        <li>
                            <i class="fa fa-check"></i>
                            <p>Valid for reservations with a 7 days rental minimum.
                                The offer is not comulative or valid for fixed plans</p>
                        </li>
                        <li>
                            <i class="fa fa-check"></i>
                            <p>Valid inparticipating cities.
                                Valid for reservations with a minimum 7 rental days</p>
                        </li>
                        <li>
                            <i class="fa fa-check"></i>
                            <p>Offer not combinable</p>
                        </li>
                        <li>
                            <i class="fa fa-check"></i>
                            <p>Offer not valid on renting plans.</p>
                        </li>
                        <li>
                            <i class="fa fa-check"></i>
                            <p>Validity: From Monday 14 de February 2022 to
                                Friday 22 de April 2022</p>
                        </li>
                    </ul>
                </div>
            </div>
