...
<body>
    ...
    <div class="doro">
        <div class="del_ret_form merida">
            <div class="page_main_title">
                <h2>Car Rental Merida</h2>
            </div>
        ...
        <div class="botm_para">
            <div class="botm_para2">
                <p>
                    If you want to <strong>rent a car in Merida</strong>, visit our webpage and find out what option is the best
                    for you. Immerse yourself in the Mayan world and enjoy the prehispanic cities such as Kabah, Chichen Itza or Uxmal.
                </p>
                <p>
                    Explore the Yucatan Peninsula with one of the cars of Eurocpar! Make your reservation online and take
                    advantage of the excellent discounts or vist us at our offices located at the Airport or inside the
                    Hotel Fiesta Americana located at the Paseo Montejo.
                </p>
                <p>
                    Take a short drive to the Cenote Subterraneo and explore practically by yourself or visit one of the
                    cacao plantations on the Magic town of Izmal or Valladolid. Rent a car in Merida now at Europcar!
                </p>
                <p>
                    The metropolitan area includes the municipalities of Mérida, Uman and Kanasin which you can visit
                    renting thru our car rental office, web page or call center. It is the largest of the four cities
                    of the world that share the name Mérida, the other three being in Spain, Venezuela, and Philippines.
                </p>
                <h3>
                    We are the best option renting a car in Guadalajara
                </h3>
                <p>
                    The city, like much of the state, has Mayan, Spanish, French, British, and to a lesser extent Dutch
                    influences. Mérida has the highest percentage of indigenous persons of any large city in Mexico with
                    approximately 60% of all inhabitants being of the beautiful Maya ethnicity.
                </p>
                <p>
                    Yucatecan food is its own unique style and is very different from what most people consider the typical
                    "Mexican" food. It includes influences from the local Mayan culture, as well as Caribbean, Mexican,
                    European and the Middle Eastern cultures. Tropical fruit such as coconut, pineapple, plums, tamarind
                    and mamey is use for any tropical food in Yucatan.
                </p>
                <p>
                    When visiting Merida, you have to travel in the car to Progreso Yucatán. Progreso is something of a paradox;
                    its laid-back ambience is still appealing most of the year; many North Americans and Europeans who want to
                    escape their chilly winters are attracted to Progreso as a place to live part-time or even full-time. They
                    like the fact that there are restaurants, hardware stores, supermarkets, and a good hospital; all kind
                    essential services are there.
                </p>
                <h3>
                    Europcar Offices In Mérida Airport
                </h3>
                <a href="">See on Map</a>
            </div>
            <div class="city_airport">
                <div class="city_airport_main">
                    <h3>Merida - Airport</h3>
                    <p><strong>Address:</strong> Calle 32 #302 A, between 23 and 25, Colonia Manuel Crescencio Rejón.</p>
                    <p><strong>Telephone:</strong> <a href=""> +52 (999) 400 5893</a></p>
                    <a href="javascript:void(0)" class="office_select_btn">SELECT THIS OFFICE <i class="fa fa-chevron-right"></i></a>
                </div>
                <div class="city_airport_main">
                    <h3>Merida - Downtown</h3>
                    <p><strong>Address:</strong> Calle 58 number 480 Local A for 57 and 59 Colonia Centro CP 9700 Merida Yucatan</p>
                    <p><strong>Telephone:</strong> <a href=""> 999 (429) 9754</a></p>
                    <a href="javascript:void(0)" class="office_select_btn">SELECT THIS OFFICE <i class="fa fa-chevron-right"></i></a>
                </div>
            </div>
            <div class="ooihz">
                <div class="right_ooihz">
                    ...
                    <div class="right_ooihz_content">
                        <ul class="acoh">
                            ...
                            <li>
                                <p>Calle 32 #302 A, between 23 and 25, Colonia Manuel Crescencio Rejón.</p>
                            </li>
                            <li>
                                <h3>Contact:</h3>
                            </li>
                            <li>
                                <p><a href="">+52 (999) 400 5893</a></p>
                            </li>
                            <li>
                                <h3>Opening Hours:</h3>
                            </li>
